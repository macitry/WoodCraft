...
export const mockTemplates: FurnitureTemplate[] = [
  ...
  {
    id: 'cross-beam-desk',
    name: 'Cross-Beam Desk',
    type: 'desk',
    description: 'Reinforced desk with additional cross beams between front and back legs.',
    parameters: [
  ...
  {
    id: 'side-cross-desk',
    name: 'Side Cross Desk',
    type: 'desk',
    description: 'Reinforced desk with cross beams between left and right legs.',
    parameters: [
      { id: 'width', name: '桌面宽度', defaultValue: 1200, unit: 'mm', min: 600, max: 3000, step: 10 },
      { id: 'depth', name: '桌面深度', defaultValue: 600, unit: 'mm', min: 400, max: 1200, step: 10 },
      { id: 'height', name: '桌面高度', defaultValue: 750, unit: 'mm', min: 500, max: 1300, step: 10 },
